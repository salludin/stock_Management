...
<title>Adapt Stock - Easy Inventory Management System</title>
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-primary">
        <div class="panel-heading"> <strong class="">Adapt Stock - Easy Inventory Management System</strong> </div>
        <div class="panel-body">
          ...
          <form class="form-horizontal" id="install_form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input class="form-control input_text" type="text" id="username" name="username">
              </div>
            </div>
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-4 control-label">Database Password</label>
              <div class="col-sm-8">
                <input class="form-control input_text" type="password" id="password" name="password">
              </div>
            </div>
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-4 control-label">Database Name</label>
              <div class="col-sm-8">
                <input class="form-control input_text" type="text" id="database" name="database">
              </div>
            </div>
        ...
        <div class="panel-footer"><?php echo date('Y');?> &copy Adapt Stock</div>
      </div>
    </div>
  </div>
</div>
