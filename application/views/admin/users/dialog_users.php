...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><i class="icon-pencil7"></i> <?php echo $this->lang->line('xin_edit_user_staff');?></h4>
</div>
<?php $attributes = array('name' => 'edit_user', 'id' => 'edit_user', 'autocomplete' => 'off');?>
<?php $hidden = array('_token' => $_GET['user_id'],'ext_name' => $first_name);?>
<?php echo form_open('admin/users/update/'.$user_id, $attributes, $hidden);?>
      ...
      <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <span class="box-96 mr-0-5"> <img class="b-a-radius-circle" width="50px" src="<?php echo site_url();?>uploads/users/<?php echo $profile_photo;?>" alt=""> </span>
            <?php } ?>
          </div>
        </div>
      </div>
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><i class="icon-eye4"></i> <?php echo $this->lang->line('xin_view_user_staff');?></h4>
</div>
<form class="m-b-1">
  <div class="modal-body">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="display: table-cell;"><?php if($profile_photo!='' || $profile_photo!='no-file'){?>
              <div class="avatar box-48 mr-0-5"> <img width="50px" src="<?php echo site_url();?>uploads/users/<?php echo $profile_photo;?>" alt=""></a> </div>
              <?php } ?></td>
          </tr>
        </tbody>
      </table>
