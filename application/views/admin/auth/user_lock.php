...
<body class="hold-transition login-page" style="background-position: center center; background-size: cover; background-image: url('<?php echo base_url();?>skin/hrsale_assets/img/bg/bg-2.jpg');">
    ...
    <div class="box box-widget widget-user-2">
        ...
        <div class="widget-user-header bg-yellow">
          <div class="widget-user-image">
            <?php  if($iresult[0]->profile_photo!='' && $iresult[0]->profile_photo!='no file') {?>
              <img src="<?php  echo base_url().'uploads/users/'.$iresult[0]->profile_photo;?>" alt="<?php echo $iresult[0]->first_name;?> <?php echo $iresult[0]->last_name;?>" class="img-circle">
              <?php } else {?>
