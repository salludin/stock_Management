...
<div class="login-box animated fadeInDownBig"> 
  ...
  <div class="login-box-body">
    <div class="login-logo"> 
      ...
      <img src="<?php echo base_url();?>uploads/logo/signin/<?php echo $company[0]->sign_in_logo;?>" alt="adapt-accounts logo"> </div>
	...
	if($system[0]->employee_login_id=='username'):
		...
		$ilogn_info = 'fionagrace';
	    $ilogn_info2 = 'david@adaptstock.com';
		$ilogn_info3 = 'logan@adaptstock.com';
	endif;?>
    ...
    <div class="form-group has-feedback">
      <input type="password" class="form-control" id="ipassword" name="ipassword" placeholder="<?php echo $this->lang->line('xin_login_enter_password');?>" autocomplete="off">
