...
<body class="hold-transition login-page" style="background-position: center center; background-size: cover; background-image: url('<?php echo base_url();?>skin/hrsale_assets/img/bg/21.jpg');">
<div class="login-box animated fadeInDownBig"> 
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg"><?php echo $this->lang->line('xin_reset_password_acc');?></p>
