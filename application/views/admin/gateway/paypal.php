	   ...
	   <div class="col-md-4 col-md-offset-4" style="margin-top:100px;">  
         <div class="panel panel-default">
		  <div class="panel-body">
		    ...
		    <h4 class="confirm-gateway">Invoice Number: <?php echo $prefix." ".$invoice_number; ?></h4>
            ...
            <?php echo form_open('admin/gateway/paypal_process', $attributes, $hidden);?>
			  <button type="submit" class="btn btn-info btn-block">Confrim</button>					 
			<?php echo form_close(); ?>
		  </div>
		</div>
	  </div>  
