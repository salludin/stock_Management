...
if(isset($_GET['jd']) && isset($_GET['customer_id']) && $_GET['data']=='customer'){
?>

<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><i class="icon-pencil7"></i> <?php echo $this->lang->line('xin_edit_customer');?></h4>
</div>
...
<?php echo form_open_multipart('admin/customers/update/'.$customer_id, $attributes, $hidden);?>
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
              ...
              <select class="form-control" name="company_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_country');?>">
      ...
      <div class="col-md-3">
        <fieldset class="form-group">
          ...
          <?php if($profile_picture!='' || $profile_picture!='no-file'){?>
           <span class="avatar box-48 mr-0-5"> <img width="50px" class="" src="<?php echo base_url();?>uploads/customers/<?php echo $profile_picture;?>" alt=""> </span>
          <?php } ?>    
      </div>
    </div>
  </div>
				...
				success: function(JSON)
				{
					if (JSON.error != '') {
						...
						var xin_table = $('#xin_table').dataTable({
							"bDestroy": true,
							"ajax": {
								url : "<?php echo site_url("admin/customers/customers_list") ?>",
								type : 'GET'
							},
							dom: 'lBfrtip',
...
<?php } else if(isset($_GET['jd']) && $_GET['data']=='view_customer' && isset($_GET['customer_id']) ){
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><i class="icon-eye4"></i> <?php echo $this->lang->line('xin_view_customer');?></h4>
</div>
<form class="m-b-1">
  <div class="modal-body">
    ...
    <table class="footable-details table table-striped table-hover toggle-circle">
      <tbody>
        <tr>
          <th><?php echo $this->lang->line('xin_customer_name');?></th>
        ...
        <tr>
          <th><?php echo $this->lang->line('xin_customer_photo');?></th>
          <td style="display: table-cell;"><?php if($profile_picture!='' || $profile_picture!='no-file'){?>
            <div class="avatar box-48 mr-0-5"> <img src="<?php echo base_url();?>uploads/customers/<?php echo $profile_picture;?>" alt="" class="user-image-hr100 ui-w-100 rounded-circle"></a> </div>
            <?php } ?></td>
        </tr>
      </tbody>
    </table></div>
